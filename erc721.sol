...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function safeTransferFrom(address from, address to, uint256 _tokenId) public virtual override {
        ...
        safeTransferFrom(from, to, tokenId, tokenIdBytes);
    }

    /**
     * @dev See {IERC721-safeTransferFrom}.
     */
    function safeTransferFromERC998(address from, address to, uint256 tokenId, uint256 toTokenId) public virtual {
        uint256 toTokenId = toTokenId;
        bytes memory tokenIdBytes = new bytes(32);
        assembly { mstore(add(tokenIdBytes, 32), toTokenId) }
...
contract Is is ERC721, Ownable {  
  ...
  function mintItem(address user_, uint256 tokenId_, string memory tokenURI_) public returns (uint256) {
  ...
  function toBytes(uint256 x) public returns (bytes memory tokenIdBytes) {
    uint256 tokenId = 6;
    bytes memory tokenIdBytes = new bytes(32);
    assembly { mstore(add(tokenIdBytes, 32), tokenId) }
  }
